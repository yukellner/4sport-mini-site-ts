            ...
            <header id="main-header" className="main-header">
                ...
                <div className="navbar" >
                    <ul id="navbar">
                        ...
                        {/* {event.customPage && <li><NavLink className={({ isActive }) => (isActive ? "active-class" : "not-active-class")} onClick={showModal} to={`${basePath}/${event.customPage.name}`}>{event.customPage.name}</NavLink></li>}{event.showMaps &&<li><NavLink className={({ isActive }) => (isActive ? "active-class" : "not-active-class")} onClick={showModal} to={`${basePath}/maps`}>מפות ומסלולים</NavLink></li>} */}
